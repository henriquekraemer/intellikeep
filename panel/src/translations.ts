const messages = {
  en: {
    ...
    linkedEntitiesCount: (n: number) => `${n} entit${n !== 1 ? "ies" : "y"}`,
    ...
    dueDateSnapped: (d: string) => `Due date moved to the next selected day: ${d}`,
  ...
  pt: {
    ...
    linkedEntitiesCount: (n: number) => `${n} entidade${n !== 1 ? "s" : ""}`,
    ...
    dueDateSnapped: (d: string) => `Data prevista movida para o próximo dia selecionado: ${d}`,
  ...
  es: {
    ...
    linkedEntities: "Entidades vinculadas",
    linkedEntitiesCount: (n: number) => `${n} entidad${n !== 1 ? "es" : ""}`,
    ...
    dueDateSnapped: (d: string) => `Fecha de vencimiento movida al siguiente día seleccionado: ${d}`,
